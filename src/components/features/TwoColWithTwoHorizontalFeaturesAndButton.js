...
const Container = tw.div`relative ml-10`;
...
const FeatureIconContainer = styled.div`
  ...
  ${props => [
    ...
    props.iconFilled && tw`border-0 bg-green-700 text-gray-100`
  ]}
  svg {
    ${tw`w-5 h-5`}
  }
...
export default ({
  ...
  description = "Discover excellence in our online medical training program, meticulously designed and expertly taught by leading practitioners in the field, ensuring you receive the highest-quality education and skills to excel in healthcare.",
  ...
  const defaultFeatures = [
    ...
    },
    {
      Icon: MoneyIcon,
      title: "Affordable",
      description: "We assure you a competitive rate, in line with industry standards.",
